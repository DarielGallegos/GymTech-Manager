      ...
      <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm dark:divide-gray-700 dark:bg-gray-900 rounded-md">
        ...
        <tbody class="divide-y divide-gray-200 dark:divide-gray-700 text-center">
          <tr class="odd:bg-gray-800">
            ...
            <td>
              <button class="inline-block rounded-full border border-red-600 bg-red-600 p-3 text-white hover:bg-transparent hover:text-red-600 focus:outline-none focus:ring active:text-red-500"><i class="nf nf-oct-trash"></i></button>
            </td>
          </tr>
        </tbody>
      </table>

...
<?php
    ...
    try {
        ...
        //prepara la consulta
        $query = "INSERT INTO empleados(nombres, `apellido-paterno`, `apellido-materno`, dni, `fecha-nac`,genero, ID_CARGO,  ID_HORARIO, telefono, email , domicilio, `fecha-inicio-labores` ) values(?,?,?,?,?,?,?,?,?,?,? ,?)";

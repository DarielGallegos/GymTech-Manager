<?php
	include $_SERVER['DOCUMENT_ROOT'].'.././GymTech-Manager-main/src/controladores/clientes_controller.php';
 
     // Instanciar el controlador de empleados
     $controlador = new ctrClientes();
    
     // Obtener los empleados
     $result = $controlador->get_clientes();

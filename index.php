...
?>
      ...
      <body class="bg-gray-200" data-new-gr-c-s-check-loaded="14.1165.0" data-gr-ext-installed="">
            ...
            <div class="min-h-screen bg-gray-900 flex justify-center items-center">
                  <div class="absolute w-60 h-60 rounded-xl bg-yellow-300 -top-5 -left-16 z-0 transform rotate-45 hidden md:block"></div>
                  <div class="absolute w-48 h-48 rounded-xl bg-yellow-300 -bottom-6 -right-10 transform rotate-12 hidden md:block"></div>
                  <form id="form-log" class="py-12 px-12 bg-white rounded-2xl shadow-xl z-20">
                        ...
                        <div class="text-center mt-6">
                              <button type="submit" class="w-full py-2 text-xl text-white bg-yellow-500 rounded-lg hover:bg-yellow-500 transition-all">Ingresar</button>
                        </div>
                  </form>
                  <div class="w-40 h-40 absolute bg-yellow-100 rounded-full top-0 right-12 hidden md:block"></div>
                  <div class="w-20 h-40 absolute bg-yellow-200 rounded-full bottom-20 left-10 transform rotate-45 hidden md:block"></div>
            </div>
